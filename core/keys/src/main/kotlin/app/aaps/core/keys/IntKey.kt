...
enum class IntKey(
    ...
    ApsMaxMinutesOfBasalToLimitSmb("smbmaxminutes", 30, 15, 400, defaultedBySM = true, dependency = BooleanKey.ApsUseSmb),
    ApsUamMaxMinutesOfBasalToLimitSmb("uamsmbmaxminutes", 30, 15, 400, defaultedBySM = true, dependency = BooleanKey.ApsUseSmb),
